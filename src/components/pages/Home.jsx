  ...
  return (
    ...
    >
      <header className="w-full h-16 bg-transparent mb-8">
        <nav className="w-full h-full flex justify-between items-center lg:pl-0 lg:pr-8 sm:pr-4 pl-2 relative">
          <motion.img
            src={transparentLogo}
            width={250}
            height={250}
            alt="salesverse logo"
            className="max-96 max-h-44 object-cover -translate-x-8"
          />
