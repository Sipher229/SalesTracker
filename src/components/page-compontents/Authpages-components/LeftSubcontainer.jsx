...
function LeftSubContainer(){
    return (
      <>
        <div className='h-full lg:w-1/2 sm:w-full sm:flex sm:justify-center lg:grid lg:grid-rows-12 lg:grid-cols-6 sm:items-center box-border'>
          <div className='lg:col-start-2 lg:col-span-6 lg:row-start-2 lg:row-span-3 lg:block sm:w-full sm:h-auto sm:flex sm:justify-center sm:items-center'>
            <Logo />
          </div>
