...
function PublicFacingHeader() {
  return (
            <header className="w-full h-16 bg-gradient-to-tl from-mygreen-750 to-mygreen-500">
                <nav className="w-full h-full flex justify-between items-center lg:pl-0 lg:pr-8 sm:pr-4 sm:py-4 sm:pl-1">
                    <img src={transparentLogo} width={250} height={250} alt="salesverse logo" className="max-96 max-h-44 object-cover -translate-x-8" />
